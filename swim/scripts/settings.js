...
export const settingVariables = [
    ...
    {
        id: "healthPotionOptions",
        config_type: String,
        tab: "Item Options",
        default:
            "Minor Health Potion|Health Potion|Greater Health Potion|Minor Healing Potion|Healing Potion|Greater Healing Potion",
    },
    {
        id: "fatiguePotionOptions",
        config_type: String,
        tab: "Item Options",
        default:
            "Minor Potion of Well-Being|Potion of Well-Being|Greater Potion of Well-Being|Minor Recreational Potion|Recreational Potion|Greater Recreational Potion",
    },
    ...
    {
        id: "shapeChange-raiseScaleMultiplier",
        config_type: Number,
        tab: "Macro Options",
        default: SWIM.RAISE_SCALE_DEFAULT,
        min: SWIM.RAISE_SCALE_MIN,
        max: SWIM.RAISE_SCALE_MAX,
        step: 0.01,
    },
    {
        id: "shapeChange-numMorphs",
        config_type: Number,
        tab: "Macro Options",
        default: SWIM.NUM_MORPHS_DEFAULT,
        min: SWIM.NUM_MORPHS_MIN,
        max: SWIM.NUM_MORPHS_MAX,
        step: 1,
    },
    ...
    {
        id: "campfireImgOn",
        config_type: window.Azzu.SettingsTypes.FilePickerVideo,
        tab: "Macro Options",
        default: "modules/jb2a_patreon/Library/Generic/Fire/Campfire/Bonfire_02_Regular_Orange_400x400.webm",
    },
    ...
    {
        id: "shakenSFX",
        config_type: window.Azzu.SettingsTypes.FilePickerAudio,
        tab: "SFX & VFX Options",
    ...
    { id: "healVFX", config_type: window.Azzu.SettingsTypes.FilePickerVideo, tab: "SFX & VFX Options", default: "" },
    {
        id: "looseFatigueSFX",
        config_type: window.Azzu.SettingsTypes.FilePickerAudio,
        tab: "SFX & VFX Options",
...
export function register_settings() {
    ...
    game.settings.register("swim", "raise-calculator", {
        name: "SWIM.raise-calculator.setting.name",
        hint: "SWIM.raise-calculator.setting.hint",
        type: Boolean,
        default: false,
        scope: "world",
        config: true,
