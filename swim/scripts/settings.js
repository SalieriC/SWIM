...
export const settingVariables = [
    ...
    {id: 'encounterTableStrangers', config_type: String, tab: "Tables & Playlists", default: 'Travel Encounters: Strangers'},
    {id: 'encounterTableTreasures', config_type: String, tab: "Tables & Playlists", default: 'Travel Encounters: Treasures'},
    ...
    {id: 'mirrorToken', config_type: String, tab: "Macro Options", default: "character", 
        options: [
            {value: 'all', locaString: 'SWIM.Option-characterAndNPC'},
            {value: 'character', locaString: 'SWIM.Option-characterOnly'},
            {value: 'npc', locaString: 'SWIM.Option-npcOnly'},
...
export function register_settings() {
    ...
    game.settings.register('swim', 'v2MigrationDone', {
        name: "v1MigrationName",
        hint: "v1MigrationHint",
        type: Boolean,
        default: false,
